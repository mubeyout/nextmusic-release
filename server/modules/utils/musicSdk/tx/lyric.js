...
exports.default = {
    ...
    getLyric(songmid) {
        ...
        const requestObj = (0, request_1.httpFetch)(`https://c.y.qq.com/lyric/fcgi-bin/fcg_query_lyric_new.fcg?songmid=${songId}&g_tk=5381&loginUin=0&hostUin=0&format=json&inCharset=utf8&outCharset=utf-8&platform=yqq`, {
            headers: {
