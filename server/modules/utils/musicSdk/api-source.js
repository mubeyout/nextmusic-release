...
exports.supportQuality = exports.apis = void 0;
const api_source_info_1 = __importDefault(require("./api-source-info"));
// 服务器端不使用内置的测试 API，全部走自定义源
// 如果需要内置 API，应该在各个源的 index.js 中单独导入
const allApi = {};
const apiList = {};
const supportQuality = {};
exports.supportQuality = supportQuality;
for (const api of api_source_info_1.default) {
...
const getUserApis = () => {
    ...
    for (const apiInfo of loadedApis) {
        if (!apiInfo.enabled || !apiInfo.sources)
            continue;
