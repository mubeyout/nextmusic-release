...
exports.default = {
    ...
    async getList(retryNum = 0) {
        ...
        const _requestObj = (0, request_1.httpFetch)('http://musicapi.qianqian.com/v1/restserver/ting?from=android&version=7.0.2.0&channel=ppzs&operator=0&method=baidu.ting.search.hot', {
            method: 'get',
            headers: {
