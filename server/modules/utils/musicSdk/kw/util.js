...
exports.wbdCrypto = exports.lrcTools = exports.decodeLyric = exports.matchToken = exports.formatPic = exports.formatSinger = exports.objStr2JSON = void 0;
...
const decodeLyricInternal = async (buf, isGetLyricx) => {
    ...
    if (!isGetLyricx)
        return iconv_lite_1.default.decode(lrcData, 'gb18030');
    ...
    return iconv_lite_1.default.decode(Buffer.from(output), 'gb18030');
};
...
const createAesDecrypt = (buffer, mode, key, iv) => {
    const cipher = (0, crypto_1.createDecipheriv)(mode, key, iv);
    return Buffer.concat([cipher.update(buffer), cipher.final()]);
};
exports.wbdCrypto = {
    aesMode: 'aes-128-ecb',
    ...
    createSign(data, time) {
        ...
        return (0, utils_1.toMD5)(str).toUpperCase();
    },
    buildParam(jsonData) {
