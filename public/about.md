...
基于 [XCQ0607/lxserver](https://github.com/XCQ0607/lxserver)（fork 自 [lyswhut/lx-music-sync-server](https://github.com/lyswhut/lx-music-sync-server)）深度定制的私有音乐同步服务端 · NextMusic 品牌版。
...
- **本仓库**：NextMusic Server（lxserver fork，NextMusic 品牌化 UI / 管理台重建）
- **直接上游**：[XCQ0607/lxserver](https://github.com/XCQ0607/lxserver) v2.0.1 · Web 管理界面 / 快照 / WebDAV / Subsonic 等增强功能的原始实现
- **根源项目**：[lyswhut/lx-music-sync-server](https://github.com/lyswhut/lx-music-sync-server) · LX Music 官方同步服务端（Apache-2.0）
